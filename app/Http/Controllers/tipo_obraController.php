...
class tipo_obraController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (!empty($params_array)) {
            ...
            $validate = \validator::make($params_array, [
                ...
                'nombre' => 'required|unique:tipo_obra'
            ]);
            ...
            if ($validate->fails()) {
                ...
                $data = [
                    ...
                    'code'      => 200,
                    'status'    => 'success',
                    'mensaje'   => 'Se ha guardado correctamente el tipo de obra',
                    'data'      => $dt
    ...
    public function update(Request $request, $id)
    {
        ...
        if (!empty($params_array)) {
            ...
            $dt = tipo_obra::where('id', $id)->update($params_array);
