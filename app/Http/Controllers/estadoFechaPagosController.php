...
use App\estadoFechaPagos;
class estadoFechaPagosController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if(!empty($params_array)){
            ...
            $validate = \Validator::make($params_array,[
                ...
                'nombre'=> 'required|nombre|unique:estado_fecha_pago'
    ...
    public function update(Request $request, $id)
    {
        ...
        if(!empty($params_array)){
            ...
            $dt = estadoFechaPagos::where('id',$id);
