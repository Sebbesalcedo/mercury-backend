...
CREATE TABLE proyectos(
  ...
  CONSTRAINT pk_user_create FOREIGN KEY (id_user) REFERENCES  users(id),
  CONSTRAINT pk_estado_proyecto FOREIGN KEY (id_estado)    REFERENCES estado_proyecto(id)
...
CONSTRAINT fk_tipo_obra FOREIGN KEY (id_tipo_obra) REFERENCES  tipo_obra(id),
